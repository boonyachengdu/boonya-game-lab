...
`docker build -t docker.io/boonyadocker/meta-k8s:latest .`
...
`docker push docker.io/boonyadocker/meta-k8s:latest`
...
`kubectl get deployment meta-k8s`
...
`kubectl get svc meta-k8s-service`

`kubectl get svc meta-k8s-service -w`
